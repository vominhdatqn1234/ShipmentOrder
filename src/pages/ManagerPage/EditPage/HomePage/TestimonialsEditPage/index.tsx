    ...
    <>
      ...
      >
        <FormItem
          ...
          label="Tiêu đề"
        >
          <Input.TextArea allowClear placeholder="Nhập tiêu đề review" />
        </FormItem>
        <FormItem
          control={control}
          name="reviewer"
          // valuePropName='fileList'
          label="Upload hình ảnh khách hàng review"
        >
          <Dragger
            {...props}
          ...
          >
            ...
            {!isEditReviewer && fileList?.length > 0 && (
              <p className="text-red-600">
                Đề cập nhật thông tin reviewer cần nhấn nút cập nhật để update
                data lên hện thống
              </p>
            )}
          </Dragger>
      ...
      <Modal
        ...
        title="Cập nhật thông tin người review"
      >
        <ReviewerForm
          refetch={refetch}
          data={data}
